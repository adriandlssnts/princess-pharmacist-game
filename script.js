...
const storyStages = [
  {stage:1,story:"Stage 1: Basic common conditions.",patients:[
    ...
    {name:"Ethan",age:40,weight:80,condition:"Common cold",allergies:[],options:["Acetaminophen","Antihistamine","Cough syrup"],doses:["250 mg","500 mg"],freq:["every 6 h","every 8 h"],correct:{drug:"Acetaminophen",dose:"500 mg",freq:"every 6 h",explanation:"Symptomatic relief for cold."}},
    ...
    {name:"Jacob",age:45,weight:75,condition:"Mild hypertension",allergies:[],options:["Lisinopril","Amlodipine","Lifestyle"],doses:["10 mg","20 mg","N/A"],freq:["once daily","N/A"],correct:{drug:"Lifestyle",dose:"N/A",freq:"N/A",explanation:"Lifestyle modification first."}},
    ...
    {name:"William",age:50,weight:82,condition:"Hyperlipidemia",allergies:[],options:["Statin","Lifestyle"],doses:["10 mg","20 mg","N/A"],freq:["once daily","N/A"],correct:{drug:"Lifestyle",dose:"N/A",freq:"N/A",explanation:"Lifestyle modification emphasized."}}
  ]},
